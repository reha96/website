...
export const BLOG_POSTS_CONFIG: Record<string, BlogPostMeta> = {
  ...
  "math-multivariate-prob": {
    ...
    tags: ["Multivariate", "Statistics", "Covariance", "Correlation", "Normal Distribution", "NumPy"],
    topic: "Math",
  },
  "pipeline": {
    repo: "dlh-machine_learning",
  ...
  "machine-learning-tree-models": {
    ...
    tags: ["Decision Trees", "Random Forest", "Boosting", "XGBoost", "scikit-learn", "Ensemble"],
    topic: "Machine Learning",
  },
  "data-analysis-data-preparation-visualization": {
    repo: "dlh-modern_ai",
  ...
  "data-analysis-web-scraping": {
    repo: "dlh-modern_ai",
    path: "data_analysis/web_scraping",
    tags: ["Web Scraping", "BeautifulSoup", "Requests", "Data Analysis"],
    topic: "Data Analysis",
  },
};

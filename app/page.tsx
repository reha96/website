...
export default function Home() {
  ...
  const [visibleAbstracts, setVisibleAbstracts] = useState<Record<string, boolean>>({});
      ...
      <div className="w-full max-w-4xl px-6 py-8 md:py-12">
        ...
        <div className="flex flex-col md:flex-row items-start mb-16">
          ...
          <div className="w-full md:w-2/3 md:pl-8">
            <h1 className="text-3xl font-medium text-gray-800 mb-1">Reha Tuncer</h1>
            ...
            {/* CV Link */}
            <div>
              <Link href="/CV_RT.pdf" className="text-blue-600 font-medium hover:underline">
                CV
              </Link>
            </div>
          </div>
        ...
        <div className="mb-16">
          <h2 className="text-2xl font-medium text-gray-800 mb-6">Published Papers</h2>
          ...
          <div className="mb-8 p-6 border-l-4 border-orange-500 bg-orange-50 rounded-lg shadow-sm">
            ...
            <p className="text-gray-600 mb-3">
              2024. <span className="italic">Economica</span>, Vol. 91, Issue 363, pp. 996-1022
            </p>
            
            <div className="flex flex-wrap gap-2 mb-3">
              <span className="px-2 py-1 bg-gray-100 text-sm text-gray-700 rounded">Revealed preference</span>
              <span className="px-2 py-1 bg-gray-100 text-sm text-gray-700 rounded">Heterogeneity</span>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Link href="https://osf.io/epbdq/" className="flex items-center px-3 py-1 bg-gray-200 text-sm text-gray-700 rounded hover:bg-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                </svg>
                Data & Code
              </Link>
              <Link href="/RP.pdf" className="flex items-center px-3 py-1 bg-gray-200 text-sm text-gray-700 rounded hover:bg-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                </svg>
                Preprint
              </Link>
              <Link href="https://github.com/reha96/python_for_cplex" className="flex items-center px-3 py-1 bg-gray-200 text-sm text-gray-700 rounded hover:bg-gray-300">
          ...
          <div className="mb-8 p-6 border-l-4 border-orange-500 bg-orange-50 rounded-lg shadow-sm">
            ...
            <p className="text-gray-800 mb-2">
              Tuncer R, Sergeeva A, Bongard-Blanchy K, Distler V, Doublet S, Koenig V
            </p>
            <p className="text-gray-600 mb-3">
              2023. <span className="italic">Behaviour and Information Technology</span>, Vol. 43, Issue 11, pp. 2281–2299
            </p>
            
            <div className="flex flex-wrap gap-2 mb-3">
              <span className="px-2 py-1 bg-gray-100 text-sm text-gray-700 rounded">Scarcity</span>
              <span className="px-2 py-1 bg-gray-100 text-sm text-gray-700 rounded">User experience</span>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Link href="https://osf.io/xgdpm/" className="flex items-center px-3 py-1 bg-gray-200 text-sm text-gray-700 rounded hover:bg-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                </svg>
                Data & Code
        ...
        <div>
          <h2 className="text-2xl font-medium text-gray-800 mb-6">Work in Progress</h2>
          
          <div className="mb-4 p-6 border-l-4 border-orange-500 bg-orange-50 rounded-lg shadow-sm">
            <h3 className="text-lg font-medium text-gray-800 mb-1">
              Peer skill identification and social class: Evidence from a referral experiment
            </h3>
            <p className="text-gray-600 mb-3">
              Díaz J, Munoz M, Reuben E, Tuncer R
            </p>
            
            {/* Abstract section that shows/hides based on state */}
            {visibleAbstracts["wip1"] && (
              <div className="my-4 p-4 bg-white rounded border border-gray-200">
                <h4 className="text-sm font-semibold mb-2">Abstract</h4>
                <p className="text-sm text-gray-700">
                  {abstracts["wip1"].text}
            ...
            <div className="flex flex-wrap gap-2">
              <button 
                onClick={() => toggleAbstract("wip1")}
                className="flex items-center px-3 py-1 bg-gray-200 text-sm text-gray-700 rounded hover:bg-gray-300"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                {visibleAbstracts["wip1"] ? "Hide Abstract" : "Abstract"}
              </button>
            </div>
          </div>
          ...
          <div className="mb-4 p-6 border-l-4 border-orange-500 bg-orange-50 rounded-lg shadow-sm">
            <h3 className="text-lg font-medium text-gray-800 mb-1">
              Class differences in social networks: Evidence from a referral experiment
            </h3>
            <p className="text-gray-600 mb-3">
              Munoz M, Reuben E, Tuncer R
            </p>
            
            {/* Abstract section that shows/hides based on state */}
            {visibleAbstracts["wip2"] && (
              <div className="my-4 p-4 bg-white rounded border border-gray-200">
                <h4 className="text-sm font-semibold mb-2">Abstract</h4>
                <p className="text-sm text-gray-700">
                  {abstracts["wip2"].text}
            ...
            <div className="flex flex-wrap gap-2">
              <button 
                onClick={() => toggleAbstract("wip2")}
                className="flex items-center px-3 py-1 bg-gray-200 text-sm text-gray-700 rounded hover:bg-gray-300"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                {visibleAbstracts["wip2"] ? "Hide Abstract" : "Abstract"}
              </button>
            </div>
          </div>
        </div>
